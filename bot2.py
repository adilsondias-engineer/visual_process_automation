...
class Bot:
    ...
    def get_screen_position(self,pos,w,h,target):
        ...
        if(target=='oks'):
            ...
            #: or target == 'collectall'    
            x = pos[0] # (pos[0] #+ int(w/2)) - 30 #12
            y = pos[1] + h #+ int(h/2) #148 
        else: #(target=='coins'):
            x =  pos[0] - int(w/2) # center - 5
            y =  pos[1] + int(h/2) + h # * 2 # int(h/2) + h  #center + h
    ...
    def go(self):
        ...
        while(True):
            ...
            pyautogui.click(x=1900, y=1000) # click anywhere this means it's stuck
